function [SSR_information,mean_SSR_information,SSR_stability,mean_SSR_stability]=perform_SSR_simulated_data(information_versus_sample_size,shuffle_information_versus_sample_size,true_information,subsample_size,units,stability_threshold,mean_stability_threshold,figures_directory)
...
% 6. stability_threshold - warning for unstable estiamtion for individual cells 
% 7. mean_stability_threshold - warning for unstable estiamtion for the mean
% 8. figures_directory - Path to save the results figure
...
hold on
plot(true_information(SSR_stability<stability_threshold),SSR_information(SSR_stability<stability_threshold),'.','markersize',15,'color',[0.5 0.5 0.5])
