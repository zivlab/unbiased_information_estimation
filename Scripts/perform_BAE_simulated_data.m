function [BAE_information,mean_BAE_information,BAE_fit_R_2,BAE_fit_R_2_mean]=perform_BAE_simulated_data(information_versus_sample_size,true_information,subsample_size,units,plot_results,save_figures,figures_directory)
